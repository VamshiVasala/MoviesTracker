...
SECRET_KEY = 'django-insecure-v(&&bl^6w77gp$p@7a)r*5a%ers_5tj0-=2yn2(w(gj$81%0@v'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'movies',          # database name you created in psql
        'USER': 'vamshi',        # the username you created
        'PASSWORD': 'Vamshi',# the password you set
